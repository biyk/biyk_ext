...
## Общение
В качестве свободного действия ты можешь передать сообщение союзникам или врагам, одно за раз
message/draconic/Я кобольд!!!
...
use/id_оружия
message/язык_сообщения/текст сообщения
